...
_Tener conocimientos en HTML y CSS(transiciones y transformaciones)_
### Transiciones en Css
```css
 /* Apply to 1 property */
...
### Enlaces de investigación
  - Css Reference: Para conocer la propiedades de Css y ejemplos funcionales
    https://cssreference.io/
  - Mozilla developer: Contienen ejemplos funcionales + código 
